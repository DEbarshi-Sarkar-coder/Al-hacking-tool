...
██║  ██║███████╗    ██║  ██║██║  ██║╚██████╗██║  ██╗██║██║ ╚████║╚██████╔╝       ██║   ╚██████╔╝╚██████╔╝███████╗███████║
╚═╝  ╚═╝╚══════╝    ╚═╝  ╚═╝╚═╝  ╚═╝ ╚═════╝╚═╝  ╚═╝╚═╝╚═╝  ╚═══╝ ╚═════╝        ╚═╝    ╚═════╝  ╚═════╝ ╚══════╝╚══════╝ v1
  Coded by Debarshi Sarkar
  youtube:www.youtube.com/@Who-h6y
\033[33;4mVersion:\033[0m 1            \033[33;4mCTRL+C:\033[0m exit          \033[33;4mAuthor:\033[0m Kali D.S (kali linux debarshi sarkar) 
...
python3 DRipper.py
echo ""
echo -e "\033[47;3;35m Before using it, hide your IP address.\033[0m"

elif [[ $process == 7 || $process == 07 ]]; then
clear
echo "Youtube Video: https://www.youtube.com/@Who-h6y"
python3 -m webbrowser https://www.youtube.com/@Who-h6y
sleep 10
...
echo -e "\033[47;3;35m shkoni te your browser / change the proxy (sock proxy) to 127.0.0.1:9050\033[0m"
sleep 8
python3 install.py
aut
	...
	clear
        echo -e '\033[36;40;1m You entered the wrong code and are you a blind person or what ? or you need a doctor ! bro'	
	sleep 1
	clear 
	bash alhack.sh
fi
